...
do
  ...
  do 
    ...
    mapshaper "wgs84/$REGION.json" -simplify 10% -proj wgs84 -o "wgs84/$REGION.geojson" id-field=statcode
    mapshaper "wgs84/$REGION.json" -simplify 10% -proj wgs84 -o "wgs84/$REGION.topojson" id-field=statcode
